        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8">
            <FieldGroup>
              ...
              <Field>
 {/* My Alert and Dialog buttons made by jamal code Starts */}
                <DialogTrigger>Dialog Poup made by Jamal</DialogTrigger>
        <AlertDialogTrigger asChild>
        <Button type="submit">Alert Poup made by Jamal</Button>
      </AlertDialogTrigger>

       {/* My Alert and Dialog buttons made by jamal code Ends */}
